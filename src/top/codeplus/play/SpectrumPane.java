...
public class SpectrumPane extends JPanel implements IAudio, AlbumReceiver {
	...
	private void drawHistogram(float[] amp) {
		...
		for (; i != band; i++, x += deltax) {
			...
			case 0:
				spectrumGraphics.drawImage(barBufferedImage, x, y, x + w, height, 0, y, w, height, null);
				break;
			case 1:
		...
		y = x / 60;
		String strMsg = String.format("[%02d:%02d] %02d:%02d", i, (int) (dura - i * 60 + 0.5), y, x - y * 60);
